...
import com.example.android.tiptime.MainActivity
import com.example.android.tiptime.R
...
class CalculatorTests {
    ...
    @Test
    fun calculate_20_percent_tip_ru() {
    ...
    @Test
    fun calculate_18_percent_tip_ru() {
        onView(withId(R.id.cost_of_service_edit_text))
            .perform(typeText("50.00"))
    ...
    @Test
    fun calculate_15_percent_tip_ru() {
        onView(withId(R.id.cost_of_service_edit_text))
            .perform(typeText("50.00"))
